...
async function init() {
  ...
  await withTimeout(db.execute(`CREATE TABLE IF NOT EXISTS payments(id TEXT PRIMARY KEY,amount TEXT NOT NULL DEFAULT '50',status TEXT NOT NULL,reason TEXT,screenshot TEXT,created_at INTEGER NOT NULL,expires_at INTEGER,password_hash TEXT)`));
